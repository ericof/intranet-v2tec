...
import { getClimaData } from 'volto-v2tec-intranet/actions/Clima/Clima';
import ClimaView from 'volto-v2tec-intranet/components/Blocks/Clima/DefaultView';
import type { ClimaBlockData } from 'volto-v2tec-intranet/components/Blocks/Clima/Data';
